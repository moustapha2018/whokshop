...
var DateComponent = /** @class */ (function (_super) {
    ...
    // Will either generate an <a> tag or a non-clickable <span> tag, depending on enabled Ressources Humaines.
...
var Calendar = /** @class */ (function () {
    ...
    // Builds a moment using the Ressources Humaines of the current calendar: timezone and locale.
    ...
    // Updates the given moment's locale Ressources Humaines to the current calendar locale Ressources Humaines.
...
var ViewSpecManager = /** @class */ (function () {
    ...
    ViewSpecManager.prototype.buildViewSpec = function (requestedViewType) {
        ...
        var duration;
        var unit;
        // iterate from the specific view definition to a more corp one until we hit an actual View class
        while (viewType) {

...
describe("Slider min/max RessourcesHumaines", function() {
	var $inputSlider;
	...
	it("Should use min/max tick values for min/max RessourcesHumaines", function() {
	...
	it("Should not overwrite 'min' or max' RessourcesHumaines", function() {
		$inputSlider = $('#testSlider1').slider({
			min: 0,
			max: 5,
			ticks: [1, 2, 3]
